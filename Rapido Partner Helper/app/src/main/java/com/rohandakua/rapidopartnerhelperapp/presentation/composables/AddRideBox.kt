                ...
                Column(
                    ...
                    if (showDialog) {
                        AlertDialog(
                            ...
                            title = { NormalText(text = "Enter Ride Details", textSize = 24) },
                            text = {
                                Column {
                                    OutlinedTextField(
                                        value = distance,
                                        ...
                                        label = { NormalText(text = "Distance in kms", textSize = 18) },
                                    ...
                                    OutlinedTextField(
                                        ...
                                        onValueChange = {
                                            timeTaken = it
                                            timeTakenError = if (it.toIntOrNull() == null || it.toIntOrNull()!! <= 0) {
                                                "Enter a valid time in minutes"
                                            } else {
                                                null
                                            }
                                        },
                                        label = { NormalText(text = "Time Taken in minutes", textSize = 18) },
                                        keyboardOptions = KeyboardOptions.Default.copy(
                                            keyboardType = KeyboardType.Number,
                                    ...
                                    OutlinedTextField(
                                        ...
                                        label = { NormalText(text = "Fare in rs", textSize = 18) },
                                        keyboardOptions = KeyboardOptions.Default.copy(
                                            keyboardType = KeyboardType.Number,
                                            imeAction = ImeAction.Next
                                        ),
